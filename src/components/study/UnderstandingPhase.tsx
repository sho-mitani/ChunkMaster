  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="glass rounded-2xl shadow-2xl p-8 animate-fadeIn">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-4 gradient-text">理解段階</h2>
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">テキスト</h3>
          <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-6 border border-gray-200 shadow-lg">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 shadow-lg">
            <div className="flex items-center gap-3">
              <span className="text-2xl font-bold text-blue-800">Level {level}</span>
        ...
        <div className="text-center">
          <button
            ...
            className={`px-12 py-4 rounded-2xl font-semibold text-lg transition-all duration-200 transform hover:scale-105 shadow-lg ${
              isCompleted
